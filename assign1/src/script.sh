...
case $1 in
    1)
        ...
        echo "Option,Size,Block Size,Time,L1 DCM,L2 TCM,L3 TCM" > $output_file
        for size in {600..3000..400}; do
            ...
            l2_tcm=$(echo "$result" | grep "L2 TCM:" | awk '{print $3}')
            l3_tcm=$(echo "$result" | grep "L3 TCM:" | awk '{print $3}')
            echo "1,$size,,${time},${l1_dcm},${l2_tcm},${l3_tcm}" >> $output_file
            echo "---------------------------------------"
        done
        ;;
    2)
        ...
        for size in {600..3000..400}; do
            ...
            l2_tcm=$(echo "$result" | grep "L2 TCM:" | awk '{print $3}')
            l3_tcm=$(echo "$result" | grep "L3 TCM:" | awk '{print $3}')
            echo "2,$size,,${time},${l1_dcm},${l2_tcm},${l3_tcm}" >> $output_file
            echo "---------------------------------------"
        done
        ;;
    3)
        ...
        for size in {4096..10240..2048}; do
            ...
            l2_tcm=$(echo "$result" | grep "L2 TCM:" | awk '{print $3}')
            l3_tcm=$(echo "$result" | grep "L3 TCM:" | awk '{print $3}')
            echo "3,$size,,${time},${l1_dcm},${l2_tcm},${l3_tcm}" >> $output_file
            echo "--------------------------------------"
        done
        ;;
    4)
        ...
        for size in {4096..10240..2048}; do
            for block in 128 256 512; do
                ...
                l2_tcm=$(echo "$result" | grep "L2 TCM:" | awk '{print $3}')
                l3_tcm=$(echo "$result" | grep "L3 TCM:" | awk '{print $3}')
                echo "4,$size,$block,${time},${l1_dcm},${l2_tcm},${l3_tcm}" >> $output_file
                echo "--------------------------------------"
            done
        done
        ;;
    5)
        ...
        for size in {600..3000..400}; do
            ...
            l2_tcm=$(echo "$result" | grep "L2 TCM:" | awk '{print $3}')
            l3_tcm=$(echo "$result" | grep "L3 TCM:" | awk '{print $3}')
            echo "5,$size,,${time},${l1_dcm},${l2_tcm},${l3_tcm}" >> $output_file
            echo "--------------------------------------"
        done
        for size in {4096..10240..2048}; do
            echo "Running ./matrixproduct 4 $size"
    ...
    6)
        ...
        for size in {600..3000..400}; do
            ...
            l2_tcm=$(echo "$result" | grep "L2 TCM:" | awk '{print $3}')
            l3_tcm=$(echo "$result" | grep "L3 TCM:" | awk '{print $3}')
            echo "6,$size,,${time},${l1_dcm},${l2_tcm},${l3_tcm}" >> $output_file
            echo "--------------------------------------"
        done
        for size in {4096..10240..2048}; do
            echo "Running ./matrixproduct 5 $size"
